...
public class Function {
    ...
    public HttpResponseMessage run(
        ...
        if (request.getHttpMethod() == HttpMethod.GET) {
            return request.createResponseBuilder(HttpStatus.OK).body("FACTURACION GET").build();
            ...
            if (body.isPresent() && !body.get().isEmpty()) {
                ...
                return request.createResponseBuilder(HttpStatus.OK).body("FACTURACION POST").build();
            }
        } else {
